...
const NewCampaign = ({ setActiveTab }) => {
      ...
      <section className="py-10 bg-transparent md:bg-base-100/50">
        ...
        <div className="lg:w-[88%] md:w-[80%] xs:w-[100%] mx-auto bg-tsansparent  h-fit self-center">
          <div>
            ...
            <h1 className="lg:text-3xl md:text-2xl sm:text-xl xs:text-xl font-serif font-extrabold mt-2 mb-2 pt-2">
              Create new Campaign
            </h1>
              ...
              <form onSubmit={getSubmitData}>
                <div className="flex text-left flex-col lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2  w-full mt-6">
                  <div className="w-full mb-4 lg:mb-0 md:mt-6 flex flex-col ">
                    <label className="mb-2 ml-0 md:ml-5 text-xs uppercase tracking-widest">
                      Name<span className="text-error text-l font-semibold">*</span>
                    </label>
                    <input
                      name="name"
                      id="name"
                  ...
                  <div className="w-full  mb-4 lg:mb-0 md:mt-6 flex flex-col justify-center ">
                    <label className="mb-2 ml-0 md:ml-5 text-xs uppercase tracking-widest">
                      Type of Campaign<span className="text-error text-l font-semibold">*</span>
                    </label>
                    <div className="relative cursor-pointer">
                      ...
                      >
                        <FontAwesomeIcon
                          icon={faCaretDown}
                          className="text-s pr-2 text-secondary absolute right-0 top-1/2 transform -translate-y-1/2"
                        />
                        {selectedOption}
                        {isOpen && (
                          <div className="absolute left-0 w-full bg-base-100/90 shadow-lg max-h-60 overflow-auto rounded-md z-10">
                            <div className="py-1 pl-4" onClick={() => handleSelectOption("1", "Stamps")}>
                              Stamps
                            </div>
                            <div className="py-1 pl-4" onClick={() => handleSelectOption("2", "Points")}>
                              Points
                            </div>
                            <div className="py-1 pl-4" onClick={() => handleSelectOption("3", "Money spent")}>
                              Money spent
                            </div>
                          </div>
                        )}
                ...
                <div className="flex text-left flex-col lg:flex-row md:flex-col sm:flex-col xs:flex-col gap-2 justify-center w-full">
                  <div className="w-full  mb-4 lg:mb-0 md:mt-6 flex flex-col justify-center">
                    <label className="mb-2 ml-0 md:ml-5 text-xs uppercase tracking-widest">
                      Value Goal<span className="text-error text-l font-semibold">*</span>
                    </label>
                    <input
                      name="value_goal"
                      id="value_goal"
                  ...
                  <div className="w-full  mb-4 lg:mb-0 md:mt-6 flex flex-col justify-center">
                    <label htmlFor="beginning_date" className="mb-2 ml-0 md:ml-5 text-xs uppercase tracking-widest">
                      Beginning Date
                    </label>
