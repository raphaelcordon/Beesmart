...
const InsightCampaign = ({ list = [], isLoading }) => {
  ...
  return (
      <>
        <div className="max-w-md w-full p-6 bg-base-100 rounded-lg shadow-lg">
          <h1 className="text-xl text-slate-600 font-semibold text-center mt-2 mb-6">Acquired Stamps - Per User</h1>
          <BarChart />
        </div>
...
{/*  <div className="p-1 flex flex-row items-center justify-center align-center text-center ">*/}
      ...
      {/*          item.is_active === true && (*/}
      {/*            <>*/}
      {/*              <div key={item.id || index} className="flex justify-center  pb-10 mb-10">*/}
